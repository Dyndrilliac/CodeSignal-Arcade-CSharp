    ...
    public static class Tests
    {
        public static class Intro
        {
            public static uint pickProblem() {
                ...
                Console.WriteLine(MENU_FORMAT, 29, "chessBoardCellColor");
                Console.WriteLine(MENU_FORMAT, 30, "circleOfNumbers");
                Console.WriteLine(MENU_FORMAT, 31, "depositProfit");
                Console.WriteLine(MENU_FORMAT, 32, "absoluteValuesSumMinimization");
                Console.WriteLine(MENU_FORMAT, 33, "stringsRearrangement");
                Console.Write("\nSelection (0 to exit):\t");
            ...
            public static void runTests(uint problem) {
                ...
                if (problem > 33) throw new PickProblemException(PROBLEM_IMPLEMENT_ERROR);
            ...
            private static bool testBed(uint problem) {
                ...
                switch (problem) {
                    ...
                    case 28:
                        ...
                        break;
                    case 29:
                        overallResult = problem29(autoTests);
                        break;
                    case 30:
                        overallResult = problem30(autoTests);
                        break;
                    case 31:
                        overallResult = problem31(autoTests);
                        break;
                    case 32:
                        overallResult = problem32(autoTests);
                        break;
                    case 33:
                        overallResult = problem33(autoTests);
                        break;
                }
            ...
            private static bool problem1(bool autoTests) {
                ...
                if (autoTests) {
                    ...
                    for (int i = 0; i < numTests; i++) {
                        ...
                        bool success = (CodeSignal.Intro.add(param1, param2) == answer);
            ...
            private static bool problem2(bool autoTests) {
                ...
                if (autoTests) {
                    ...
                    for (int i = 0; i < numTests; i++) {
                        ...
                        bool success = (CodeSignal.Intro.centuryFromYear(param1) == answer);
            ...
            private static bool problem3(bool autoTests) {
                ...
                if (autoTests) {
                    ...
                    for (int i = 0; i < numTests; i++) {
                        ...
                        bool answer = testOutput[i], success = (CodeSignal.Intro.checkPalindrome(param1) == answer);
            ...
            private static bool problem29(bool autoTests) {
                bool overallResult = true;
            ...
            private static bool problem30(bool autoTests) {
                bool overallResult = true;
            ...
            private static bool problem31(bool autoTests) {
                bool overallResult = true;
            ...
            private static bool problem32(bool autoTests) {
                bool overallResult = true;
            ...
            private static bool problem33(bool autoTests) {
                bool overallResult = true;
